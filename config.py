...
IMP_ACCESSORY_MODE = os.environ.get("IMP_ACCESSORY_MODE", "random").lower()
IMP_FLOAT_PIXELS = int(os.environ.get("IMP_FLOAT_PIXELS", "3"))
IMP_SHADOW = os.environ.get("IMP_SHADOW", "true").lower() in ("true", "1", "yes")
IMP_BACKGROUND = os.environ.get("IMP_BACKGROUND", "circuit").lower()
IMP_BACKGROUND_BRIGHTNESS = int(os.environ.get("IMP_BACKGROUND_BRIGHTNESS", "45"))
...
def print_config():
    ...
    print(f"IMP_ACCESSORY_MODE      = {IMP_ACCESSORY_MODE}")
    print(f"IMP_FLOAT_PIXELS        = {IMP_FLOAT_PIXELS}")
    print(f"IMP_SHADOW              = {IMP_SHADOW}")
    print(f"IMP_BACKGROUND          = {IMP_BACKGROUND}")
    print(f"IMP_BACKGROUND_BRIGHT   = {IMP_BACKGROUND_BRIGHTNESS}")
